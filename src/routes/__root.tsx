  ...
  return (
    <html lang="en">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `(function(){try{if(window.location.pathname!=='/pagina-intro')return;var k='falcon_sid';if(sessionStorage.getItem(k))return;var sid=typeof crypto!=='undefined'&&crypto.randomUUID?crypto.randomUUID():Date.now()+'-'+Math.random().toString(36).slice(2);sessionStorage.setItem(k,sid);fetch('https://tpzpydnvcbcdkuthyweh.supabase.co/rest/v1/form_events',{method:'POST',headers:{'apikey':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRwenB5ZG52Y2JjZGt1dGh5d2VoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzY3Njk4OTksImV4cCI6MjA5MjM0NTg5OX0.iHPl-ICfhP4bUdKseDtpn8GMUS9rn6q_aMMZKRk2kxU','Authorization':'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRwenB5ZG52Y2JjZGt1dGh5d2VoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzY3Njk4OTksImV4cCI6MjA5MjM0NTg5OX0.iHPl-ICfhP4bUdKseDtpn8GMUS9rn6q_aMMZKRk2kxU','Content-Type':'application/json','Prefer':'return=minimal'},body:JSON.stringify({session_id:sid,step:0,step_name:'Pagina Intro',completed:false}),keepalive:true}).catch(function(){});}catch(e){}})();` }} />
      </head>
      <body>
        {children}
        <Scripts />
